...
<?php
    ...
    $arg = array('post_type'=>'project','post_status'=>'publish','posts_per_page'=>30,'paged'=>$paged);
  ...
  <section id="browse" class="container">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 no-column">
        <div class="title-section box fleft text-left">
            <h1>There are currently <?php echo $project->found_posts;?> Projects for you to browse and Support</h1>
        </div>
    </div>
    ...
    <div class="col-lg-9 col-md-9 col-sm-9 col-xs-9 no-column">
        ...
        ?>
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 no-column">
            <div class=" box fleft text-left">
                 <h2 style="color:#fff;">No results were found for the search</h2>
            </div>
        </div>
        <?php endif;?>
         <?php
    ...
    <div id="sidebar" class="col-lg-3 col-md-3 col-sm-3 col-xs-3 text-left">
        ...
        <form method="get">
            ...
            <button id="singlebutton" type="submit" class="btn btn-primary">Filter</button>            
